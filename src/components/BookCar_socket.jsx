...
//   const socket = io("http://localhost:3034/api/v1");
...
//         socket.emit("register_user", { rideId: data.ride_id });
  
//         socket.on("ride_accepted", (rideDetails) => {
//           console.log("Ride accepted:", rideDetails);
  
//           // Redirect or update UI
//           window.location.href = `/track-ride/${rideDetails.rideId}`;
//         });
//       }
//     } catch (error) {
//       clearInterval(interval);
...
//   const handlePickLat = (e) => {
//     setPickLat(e.target.value);
//   };

//   const handlePickLong = (e) => {
//     setPickLong(e.target.value);
//   };

//   const handleDropLat = (e) => {
//     setDropLat(e.target.value);
//   };

//   const handleDropLong = (e) => {
//     setDropLong(e.target.value);
//   };
...
//                     <i className="fa-regular fa-calendar-days "></i> &nbsp;
//                     Drop-off latitude <b>*</b>
//                   </label>
//                   <input
//                     id="dropofflat"
//                     placeholder="Drop-off latitude"
//                     value={dropofflat}
//                     onChange={handleDropLat}
//                     type="text"
//                     style={{ padding: "10px", borderRadius: "5px" }}
//                   />
//                 </div>
